 ...
 * @author ly.phong
 */
public class FrameCreateReceipt extends javax.swing.JFrame {

    /**
     * Creates new form ManageReceipt
     */
    public FrameCreateReceipt() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCreateReceipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameCreateReceipt().setVisible(true);
            }
        });
    }
